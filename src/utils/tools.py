...
@tool
def search_user_monthly_income(user_id: int) -> Dict[str, Any]:
    """
...
@tool
def search_user_recent_expenses(user_id: int) -> Dict[str, Any]:
    """
...
@tool
def search_expense_by_month(user_id: int, month: int) -> Dict[str, Any]:
    """
